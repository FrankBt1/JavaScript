...
class Product {
  ...
  sellUnits(units) {
    if (units > this.stock){
      ...
      console.log(`Unidades vendidas: ${units}. Stock restante: ${this.stock}`);
    }
  }
...
const prod5 = new Product(1598, "teclados", 90, 12, ["imagenes3.jpg"], true, "torito", ["pink", "silver"], "A stunning product", "Incluye impuesto País y percepción AFIP");
...
//cambiando de proveedor del prod4
prod4.setsupplier ="Nokia"
console.log(prod4.getsupplier);


//vendiendo unidades del prod5
prod5.sellUnits (10)
prod5.sellUnits (5)
